...
//
// To use this with `apglib.js` in a browser web page,
// simply change the generated node.js name `module.exports` to a variable name that you can use in your code.
// Here we've used `var grammarConstructor`.
var grammarConstructor = function(){
"use strict";
  //```
  // SUMMARY
  //      rules = 7
