...
"use strict";
  ...
  this.rules[2] = {name: 'B', lower: 'b', index: 2, isBkr: false, hasBkr: true};
  ...
  this.rules[0].opcodes[2] = {type: 4, index: 2};// RNM(B)
  ...
  this.rules[2].opcodes[3] = {type: 11, index: 1, lower: 'a', insensitive: true};// BKR(\%iA)
